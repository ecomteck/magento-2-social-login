...
namespace Ecomteck\SocialLogin\Setup;
 ...
 * Class InstallSchema
 *
 * @package Ecomteck\SocialLogin\Setup
 */
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('ecomteck_social_customer')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('ecomteck_social_customer'))
                ...
                ->addForeignKey(
                    $installer->getFkName('ecomteck_social_customer', 'customer_id', 'customer_entity', 'entity_id'),
                    'customer_id',
